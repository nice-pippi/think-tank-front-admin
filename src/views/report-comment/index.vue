<template>
    <div class="app-container">
        <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit highlight-current-row>
            ...
            <el-table-column label="用户" width="170" align="center">
                <template slot-scope="scope">
            ...
            <el-table-column label="举报理由" width="350" align="center">
                <template slot-scope="scope">
                    {{ scope.row.reason }}
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="操作" width="280">
                <template slot-scope="scope">
                    <el-button size="mini" type="primary" @click="look(scope.row.content)">查看</el-button>
...
<script>
import { getList, prohibit, reject, deleteById } from '@/api/report-comment'
...
export default {
    ...
    methods: {
        ...
        look(content) {
            this.$alert(`<div class="scrollable-content">${content}</div>`, '评论内容', {
                customClass: 'comment_alert',
